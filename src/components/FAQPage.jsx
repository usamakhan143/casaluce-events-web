  ...
  const faqs = [
    {
      ...
      answer: "Ideally, reach out 6–12 months before your event. This timeframe allows us to secure the best venues and vendors, and to plan each detail meticulously. However, we can also accommodate shorter timelines depending on the complexity and scale of your event."
    },
    {
      id: 2,
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen lg:h-[calc(100vh+100px)] bg-charcoal flex flex-col">
        ...
        <div 
          ...
          style={{
            backgroundImage: `url('https://images.pexels.com/photos/2563495/pexels-photo-2563495.jpeg?auto=compress&cs=tinysrgb&w=2732&h=1536&fit=crop')`
          }}
        ></div>
          ...
          <div className="text-center text-white max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="text-center">
                ...
                <p className="font-gotham">(818) 277-7235</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="font-gotham">christopher@casaluceevents.com</p>
              </div>
