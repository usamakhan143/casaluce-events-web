            ...
            <div className="text-white space-y-8">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-gotham">+1 (555) 123-4567</p>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-gotham">info@casaluceevents.com</p>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-gotham">123 Event Planning Lane<br />Suite 456<br />City, State 12345</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="text-white">
              ...
              <div className="mt-8 p-6 bg-white bg-opacity-10 backdrop-blur-sm rounded-lg">
                ...
                <p className="text-lg font-bold font-gotham">+1 (555) 999-0123</p>
