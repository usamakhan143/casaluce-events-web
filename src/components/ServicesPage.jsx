        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg leading-relaxed text-charcoal font-gotham max-w-4xl mx-auto">
              At Casaluce Events, we offer a comprehensive range of event planning services designed to transform your vision into an unforgettable reality. Our experienced team handles every detail with precision and creativity, ensuring your event is flawlessly executed and beautifully memorable.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="section-subtitle text-white font-gotham">
              Specialized Event Planning for Life's Most Important Moments
            </p>
          </div>
            ...
            <div className="text-center">
              <div className="relative mb-6">
                <img 
                  ...
                  alt="Special Occasion Planning" 
                  className="w-full h-80 object-cover rounded-t-3xl"
                />
                <div className="absolute inset-0 bg-black bg-opacity-30 rounded-t-3xl flex items-end">
                  <div className="p-6 text-white">
                    <h3 className="text-2xl font-bold mb-2 font-seasons">Special Occasions</h3>
                    <p className="text-sm font-gotham">Celebrating Life's Precious Moments</p>
                  </div>
                </div>
              </div>
              <div className="text-white space-y-4">
                <h4 className="text-xl font-bold font-gotham">Special Event Services Include:</h4>
                <ul className="text-left text-base leading-relaxed font-gotham space-y-2">
